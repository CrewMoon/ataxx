...
public class WinnerTest {
    ...
    @Test
    public void testWinner_JUMP_LESSTHAN25() {
        Board b1 = new Board();
        String[] moves = {
                "a7-c6", "a1-c2",
                "c6-a7", "c2-a1",
        ...
        createMoves(b1, moves);
        assertEquals(null, b1.getWinner());
    }
    @Test
    public void testWinner_JUMP_MORETHAN25() {
        Board b1 = new Board();
        String[] moves = {
                "a7-c6", "a1-c2",
                "c6-a7", "c2-a1",
        ...
        createMoves(b1, moves);
        assertEquals(EMPTY, b1.getWinner());
    }
    @Test
    public void testWinner_JUMP_EQUAL25() {
        Board b1 = new Board();
        String[] moves = {
                "a7-c6", "a1-c2",
                "c6-a7", "c2-a1",
    ...
    @Test
    public void testWinner_NOPIECE_RED() {
        Board b2 = new Board();
        String[] moves = {
                "a7-c5", "a1-c3",
                "g1-e3","c3-d4",
        };
        createMoves(b2, moves);
        assertEquals(BLUE, b2.getWinner());
    }
}
